...
#_form_1_ ._submit { -webkit-appearance:none; cursor:pointer; font-family:arial, sans-serif; font-size:14px; text-align:center; background:#e040fc !important; border:0 !important; -moz-border-radius:4px !important; -webkit-border-radius:4px !important; border-radius:4px !important; color:#fff !important; padding:10px !important; }
        ...
        <SectionContent>
          <NewsletterFormStyles>
            ...
            <div style={{textAlign: 'center'}}>
              <form method="POST" action="https://nadineseuffert.activehosted.com/proc.php" id="_form_1_" className="_form _form_1 _inline-form _inline-style _dark" novalidate>
                ...
                <input type="hidden" name="or" value="564e41af67598c82b6f27b8c28c42247" />
                <div className="_form-content">
                  <div className="_form_element _x08376582 _inline-style _clear" >
                    <div className="_form-title">
                      Herzkraft für Dein Postfach
                    </div>
                  </div>
                  <div className="_form_element _x03945714 _inline-style _clear" >
                    <div className="_html-code">
                      <p>
                        Herzhäppchen, möglichst kurz gefasst - für Deine Herzensenergie und Neuigkeiten rund um meine Yoga-Angebote, Workshops &amp; Retreats.
                      </p>
                    </div>
                  </div>
                  <div className="_form_element _x51370651 _inline-style " >
                  ...
                  <div className="_form_element _x24825414 _inline-style " >
              ...
              (function() {
                ...
                var form_submit = function(e) {
                  ...
                  if (validate_form()) {
                    ...
                    _load_script('https://nadineseuffert.activehosted.com/proc.php?' + serialized + '&jsonp=true');
                  }
                  return false;
                };
...
const formContent = '<script type="text/javascript"></script>';